...
const sidebars: SidebarsConfig = {
  tutorialSidebar: [
    ...
    },
    {
      ...
      items: [
        { type: 'doc', id: 'module1/overview', label: 'Overview', key: 'module1-overview' },
    ...
    },
    {
      ...
      items: [
        { type: 'doc', id: 'module2/overview', label: 'Overview', key: 'module2-overview' },
    ...
    },
    {
      ...
      items: [
        { type: 'doc', id: 'module3/overview', label: 'Overview', key: 'module3-overview' },
    ...
    },
    {
      ...
      items: [
        { type: 'doc', id: 'module4/overview', label: 'Overview', key: 'module4-overview' },
